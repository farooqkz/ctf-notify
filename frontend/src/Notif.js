...
export default class Notif extends React.Component {
  ...
  addNotif = () => {
    if (navigator.serviceWorker && window.PushManager) {
      ...
      alert(
        "Your browser does not support Notifications or you have not allowed it"
      );
    }
  };
  ...
  render() {
    ...
    return (
      <>
        <Dialog
          open={addNotif}
          onClose={() => this.setState({ addNotif: false })}
        >
          <DialogTitle>
            Notifying you when certain map(s) with enough players is being
            played
          </DialogTitle>
          <DialogContent>
            <Select
          ...
          <DialogActions>
            <Button onClick={this.addNotif}>Add notification</Button>
          </DialogActions>
        </Dialog>
        <Stack>
              ...
              {this.pushers.map((pusher) => {
                return (
                  ...
                  >
                    ...
                    <ListItemText
                      primary={`When ${pusher.players} online with ${pusher.mode}`}
                      secondary={maps[pusher.map]}
                    />
                  </ListItem>
                );
              })}
